...
def create_main(modloc, filename):
...
def makeithappen(button_name):
    ...
    create_main(modfiles, musicfile_name)
...
app = gui('MenuMusicMod Creator', '800x100')
...
# music to use
app.addLabel('musicfile_lab', 'Music to use (already in .movie format): ', 2, 0)
...
# "start" button
app.addButton('Create MenuMusicMod', makeithappen, colspan=2)
